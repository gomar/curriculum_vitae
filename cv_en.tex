...
\textit{elsA}, Fine/Turbo and Fluent \newline
...
\underline{designed a website} (www.cerfacs.fr/antares)
...
within an industrial CFD code (\textit{elsA}), \newline
...
- develop a post-processing library written in python (www.cerfacs.fr/antares)
